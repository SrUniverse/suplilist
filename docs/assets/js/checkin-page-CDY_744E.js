import{t as p,s as n,e as l,A as g}from"./main-Q5JJQYYZ.js";class f{constructor(e){this.container=e}mount(){this._render(),this._attachListeners()}unmount(){this.container.innerHTML=""}_getTodayStr(){return p()}_getCheckedIds(){const e=this._getTodayStr();return new Set(n.checkins.filter(t=>t.date===e).map(t=>t.supplementId))}_render(){const e=n.stack,t=n.calculateStreak(),r=this._getCheckedIds(),o=e.length,s=r.size,a=o>0&&s>=o,i=o>0?Math.round(s/o*100):0,c=new Date().toLocaleDateString("pt-BR",{weekday:"long",day:"numeric",month:"long"}),d=c.charAt(0).toUpperCase()+c.slice(1);this.container.innerHTML=`
      <div style="
