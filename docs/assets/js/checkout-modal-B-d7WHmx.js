var b=Object.defineProperty;var m=(o,e,a)=>e in o?b(o,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[e]=a;var d=(o,e,a)=>m(o,typeof e!="symbol"?e+"":e,a);import{s as h,A as x,S as g,e as l}from"./main-DTMwk5pg.js";class v{static show(e={}){const a=document.getElementById("premium-checkout-overlay");if(a&&(a.remove(),this._activeOverlay=null),this._activeOverlay)return;const i=e.tier==="elite"?"elite":"pro";this._injectStyles();const t=document.createElement("div");t.id="premium-checkout-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Ativar Plano Premium (Demonstração)"),t.innerHTML=`
