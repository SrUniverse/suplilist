...
`;class h{constructor(e,a){this.container=e,this.params=a||{},this._onLinkClick=this._onLinkClick.bind(this),this._onSearch=this._onSearch.bind(this)}mount(){this._injectStyles(),this.container.innerHTML=this._render(),this._bindEvents();const e=d.createFAQPageSchema(l.flatMap(a=>a.items.map(o=>({question:o.q,answer:o.a||this._stripHtml(o.aHtml)}))));d.insertSchema(e)}unmount(){this.container.innerHTML=""}_stripHtml(e){const a=document.createElement("div");return a.innerHTML=e,a.textContent||a.innerText||""}_injectStyles(){if(!document.getElementById("faq-page-styles")){const e=document.createElement("style");e.id="faq-page-styles",e.textContent=u,document.head.appendChild(e)}}_render(){return`
      <div class="faq-page">
        ...
        <div class="faq-categories">
          ${l.map((e,a)=>this._renderCategory(e,a)).join("")}
        </div>
