import{S as d}from"./stack-recommender-1yj9Hv5y.js";import{S as p,s as c,A as v}from"./main-CfSeD4Q4.js";import{E as l}from"./evidence-D5RtUc7g.js";import{e as o}from"./escape-Br5wU8qn.js";const f=()=>{const i=c.favorites;return Array.isArray(i)?i:[]},g=i=>{c.dispatch(v.REMOVE_FAVORITE,{supplementId:i})},u=[{key:"all",label:"Todos"},{key:"bulk",label:"Hipertrofia"},{key:"endurance",label:"Performance"},{key:"general",label:"Saúde Geral"},{key:"cut",label:"Emagrecimento"}];function b(i,e){return e==="all"?!0:(i.targets?.[e]??0)>0}function m(i,e){const a=[...i];if(e==="evidence"){const t={A:0,B:1,C:2};return a.sort((r,n)=>(t[r.evidenceLevel]??3)-(t[n.evidenceLevel]??3))}return e==="az"?a.sort((t,r)=>t.name.localeCompare(r.name)):a}class k{constructor(e){this.container=e,this._activeGoal="all",this._sortKey="evidence",this._handleStorageChange=this._onStorageChange.bind(this)}mount(){this._injectStyles(),window.removeEventListener("storage",this._handleStorageChange),window.addEventListener("storage",this._handleStorageChange),this._render()}unmount(){window.removeEventListener("storage",this._handleStorageChange),this.container.innerHTML=""}_onStorageChange(e){e.key===p.STATE&&this._render()}_getFavoriteSupplements(){return f().map(a=>d.find(t=>t.id===a)).filter(Boolean)}_injectStyles(){if(document.getElementById("fav-page-styles-v3"))return;const e=document.createElement("style");e.id="fav-page-styles-v3",e.textContent=`
      .fv-root {
        padding: 0 0 120px;
        min-height: 100%;
    ...
    `,document.head.appendChild(e)}_render(){const e=this._getFavoriteSupplements(),a=e.filter(r=>b(r,this._activeGoal)),t=m(a,this._sortKey);this.container.innerHTML=`
      <div class="fv-root">
        <div class="fv-header">
    ...
    `,this._bindEvents()}_renderCard(e){const a=e.image||`/assets/${e.id.replace(/-/g,"_")}.png`,t=l[e.evidenceLevel]??l.C,r=e.benefits?.[0]??"",n=e.pricePerGram?Math.round((e.dosage?.maintenance??5)*e.pricePerGram*30):null,s=n?`R$ ${n}`:null;return`
