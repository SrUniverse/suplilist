import{S as l}from"./stack-recommender-DF0wTc9D.js";import{e as i}from"./escape-Br5wU8qn.js";import"./main-Cc1NkQ61.js";class g{constructor(e){this.container=e,this._styleEl=null,this._onClick=null}mount(){this._injectStyle(),this.container.innerHTML=this._template(),this._bindEvents()}unmount(){this._onClick&&(this.container.removeEventListener("click",this._onClick),this._onClick=null),this.container.innerHTML=""}_bindEvents(){this._onClick=e=>{const o=e.target.closest("[data-nav]");if(o){e.preventDefault();const t=o.getAttribute("data-nav");t&&t.startsWith("/")&&(window.history.pushState(null,null,t),window.dispatchEvent(new PopStateEvent("popstate")));return}const r=e.target.closest("[data-action]");r&&r.getAttribute("data-action")==="scroll-features"&&document.getElementById("lp-features")?.scrollIntoView({behavior:"smooth"})},this.container.addEventListener("click",this._onClick)}_template(){const e=l.length,o=[{icon:'<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--color-brand)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>',title:"Comparação de Preços",text:"Amazon, Mercado Livre e Shopee lado a lado. Compre sempre pelo melhor preço, sem sair do app."},{icon:'<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--color-brand)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2v-4M9 21H5a2 2 0 0 1-2-2v-4m0 0h18"/></svg>',title:"Dosagem Científica",text:"Doses calculadas pelo seu peso, objetivo e biometria — sem chute, baseadas em evidência."},{icon:'<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--color-brand)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',title:"Stack Personalizado",text:"Monte, monitore e evolua seu protocolo de suplementação ao longo do tempo."}],r=[{n:"1",title:"Defina seus Objetivos",text:"Hipertrofia, longevidade, foco ou performance — você escolhe o caminho."},{n:"2",title:"Compare Preços e Doses",text:"Cruze evidência clínica e o melhor preço entre 3 marketplaces."},{n:"3",title:"Monitore e Avance",text:"Acompanhe sua adesão e ajuste o protocolo conforme você evolui."}],t=["Hipertrofia","Saúde Geral","Longevidade","Performance","Foco","Emagrecimento"],n=[{name:"Amazon",color:"#FF9900",logo:'<svg width="90" height="28" viewBox="0 0 90 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><text x="0" y="22" font-family="Arial, sans-serif" font-size="22" font-weight="700" fill="#FF9900">amazon</text></svg>'},{name:"Mercado Livre",color:"#FFE600",logo:'<svg width="110" height="28" viewBox="0 0 110 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><text x="0" y="22" font-family="Arial, sans-serif" font-size="16" font-weight="700" fill="#FFE600">Mercado Livre</text></svg>'},{name:"Shopee",color:"#EE4D2D",logo:'<svg width="80" height="28" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><text x="0" y="22" font-family="Arial, sans-serif" font-size="22" font-weight="700" fill="#EE4D2D">shopee</text></svg>'}];return`
      <div class="lp-root">
        ...
        <main>
            ...
            <div class="lp-hero__inner">
              <div class="lp-hero__left">
                ...
                <p class="lp-hero__stats lp-anim" style="--d:.32s">
                  ${e}+ Suplementos · 3 Marketplaces · 100% Offline · Evidência Clínica
                </p>
              </div>
            ...
            <div class="lp-grid lp-grid--3">
              ${o.map(a=>`
                <article class="lp-card">
                  <div class="lp-card__icon" aria-hidden="true">${a.icon}</div>
                  <h3 class="lp-card__title">${a.title}</h3>
                  <p class="lp-card__text">${a.text}</p>
                </article>`).join("")}
            </div>
          </section>
            ...
            <div class="lp-grid lp-grid--3">
              ${r.map(a=>`
                <article class="lp-step">
                  <div class="lp-step__num" aria-hidden="true">${a.n}</div>
                  <h3 class="lp-card__title">${a.title}</h3>
                  <p class="lp-card__text">${a.text}</p>
                </article>`).join("")}
            </div>
          ...
          <section class="lp-section" aria-label="Filtro por treino">
            ...
            <div class="lp-chips">
              ${t.map(a=>`<button class="lp-chip" data-nav="/list?objective=${encodeURIComponent(a)}" type="button">${a}</button>`).join("")}
            </div>
          </section>
          ...
          <section class="lp-section" aria-label="Marketplaces">
            ...
            <div class="lp-grid lp-grid--3">
              ${n.map(a=>`
                <article class="lp-market" style="--mk-color: ${a.color}">
                  <div class="lp-market__logo">${a.logo}</div>
    ...
    `}_heroMockupCards(){return`<div class="lp-mock-stack">
      ${l.slice(0,3).map(o=>{const r=((o.dosage?.maintenance??5)*(o.pricePerGram??.3)*30).toFixed(2).replace(".",","),t=o.evidenceLevel||"A";return`
          <div class="lp-mock-card">
            <div class="lp-mock-card__ev">EV. ${i(String(t))}</div>
            <div class="lp-mock-card__name">${i(o.name)}</div>
            <div class="lp-mock-card__cat">${i(o.category||"")}</div>
            <div class="lp-mock-card__price">R$ ${r}<span class="lp-mock-card__dose"> / mês</span></div>
          </div>`}).join("")}
    </div>`}_injectStyle(){if(document.querySelector('[data-page="home"]'))return;const e=document.createElement("style");e.setAttribute("data-page","home"),e.textContent=`
      .lp-root {
    ...
    `,document.head.appendChild(e),this._styleEl=e}}export{g as default};
