const l=[{key:"termos",label:"Termos de Uso"},{key:"privacidade",label:"Privacidade (LGPD)"},{key:"medico",label:"Aviso Médico"},{key:"afiliados",label:"Afiliados"}],c={termos:0,privacidade:1,medico:2,afiliados:3},s='<p class="lg-updated">Última atualização: Junho de 2026 (Sprint 23 Analytics)</p>',n=[`${s}
...
`;class g{constructor(e,o){this.container=e,this.params=o||{},this._activeIndex=c[this.params.doc]??0,this._handleTabClick=this._handleTabClick.bind(this)}mount(){this._injectStyles(),this._render(),this._bindEvents()}unmount(){this.container.innerHTML=""}_injectStyles(){if(!document.getElementById("legal-page-styles")){const e=document.createElement("style");e.id="legal-page-styles",e.textContent=p,document.head.appendChild(e)}}_render(){this.container.innerHTML=`
      <div class="lg-wrap">
        <h1>Centro Legal</h1>
