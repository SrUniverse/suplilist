import{l as P,s as m,A as S}from"./main-BbCNeYDc.js";import{S as E}from"./stack-recommender-De9B_8gK.js";import{F as T}from"./vendor-PnIxnNo9.js";import{e as n}from"./escape-Br5wU8qn.js";import{E as w}from"./evidence-D5RtUc7g.js";import{a as A}from"./affiliate-engine-DWOMM1UR.js";function z(r,t){const e=(t||"g").toLowerCase().trim();return e==="g"?r:e==="mg"?r/1e3:e==="mcg"?r/1e6:e==="ui"||e==="caps"||e==="capsules"||e==="pills"?r/1e3:r}const F=30,M=24,R=300;function I(r){if(!r||typeof r!="string")return"#";try{const t=new URL(r);return["https:","http:"].includes(t.protocol)?r:"#"}catch{return"#"}}function B(r){return/amzn\.to\/|amazon\.com\.br\/dp\/|meli\.la\/|shope\.ee\//.test(r??"")}const G=["Todos","Performance","Proteínas","Vitaminas","Adaptógenos","Hormônios","Cognição","Antioxidantes","Sono","Saúde Geral"],N=["Hipertrofia","Saúde Geral","Longevidade","Performance","Foco"],H={Hipertrofia:"bulk","Saúde Geral":"general",Longevidade:"general",Performance:"endurance",Foco:"endurance"},L=M;function $(r){return r.pricePerUnit??r.price}function O(r,t){const e=t&&t[r.id]?Object.values(t[r.id]):null;return!e||!e.length?null:e.reduce((o,l)=>$(o)<$(l)?o:l)}function q(r,t){const e=O(r,t);if(e)return{price:e.price,label:e.label};const o=r.dosage?.maintenance??5,l=r.dosage?.unit||"g",a=r.pricePerGram??.3;return{price:z(o,l)*a*F,label:null}}function D(r,t){const e=O(r,t);if(e){if(e.pricePerUnit&&e.unit){const c=r.dosage?.maintenance??5,d=z(c,e.unit);return`R$ ${(e.pricePerUnit*d).toFixed(2).replace(".",",")} / dose`}return`R$ ${(e.price/F).toFixed(2).replace(".",",")} / dose`}const o=r.dosage?.maintenance??5,l=r.dosage?.unit||"g",a=r.pricePerGram??.3;return`R$ ${(z(o,l)*a).toFixed(2).replace(".",",")} / dose`}function V(r,t){const e=r.id;if(!t||!t[e])return null;const o=Object.values(t[e]),l=Math.max(...o.map(a=>a.saving||0));return l>0?l:null}function U(r,t){if(!t||t==="Todos")return!0;const e=(r.category||"").toLowerCase();return t==="Performance"?e.includes("força")||e.includes("performance")||e.includes("resistência")||e.includes("endurance")||e.includes("queima")||e.includes("gordura")||e.includes("recovery"):t==="Proteínas"?e.startsWith("prote"):t==="Vitaminas"?e.includes("vitam"):t==="Adaptógenos"?e.includes("adapt"):t==="Hormônios"?e.includes("hormon")||e.includes("testoster")||e.includes("libido"):t==="Cognição"?e.includes("cogni")||e.includes("neuro")||e.includes("foco"):t==="Antioxidantes"?e.includes("antioxid")||e.includes("anti-inflamat"):t==="Sono"?e.includes("sono")||e.includes("recuper"):t==="Saúde Geral"?e.includes("saúde")||e.includes("geral")||e.includes("imun")||e.includes("intestin")||e.includes("articular")||e.includes("pele")||e.includes("mineral")||e.includes("miner")||e.includes("omega")||e.includes("ômega"):!0}function K(r,t){if(!t)return!0;const e=H[t];return e?r.targets&&r.targets[e]!=null&&r.targets[e]>0:!0}function _(){return new Set(m.favorites??[])}function J(r){_().has(r)?m.dispatch(S.REMOVE_FAVORITE,{supplementId:r}):m.dispatch(S.ADD_FAVORITE,{supplementId:r})}function C(r){return`R$ ${Number(r).toFixed(2).replace(".",",").replace(/\B(?=(\d{3})+(?!\d))/g,".")}`}class te{constructor(t,e={}){this.container=t,this._unsubscribe=null,this._fuse=null,this._allItems=[],this._filtered=[],this._page=0,this._query="",this._category="Todos",this._objective=e.objective||"",this._prices=null,this._modalOpen=null,this._debounceTimer=null,this._observer=null,this._boundKeydown=this._onKeydown.bind(this),this._scrollLockStack=[]}mount(){this._attachStyles(),this._allItems=E,this._fuse=new T(this._allItems,{keys:["name","category","benefits"],threshold:.35,includeScore:!0,ignoreLocation:!0}),this._fetchController=new AbortController,fetch("/data/prices.json",{signal:this._fetchController.signal}).then(t=>t.ok?t.json():Promise.reject(new Error(`HTTP ${t.status}`))).then(t=>{this._prices=t,this._renderGrid()}).catch(t=>{t.name!=="AbortError"&&P.warn("[ListPage] prices.json failed to load, using estimates:",t.message)}),this._render(),this._syncObjectiveChip(),this._applyFilters(),this._renderStats(),this._renderGrid(),this._initInfiniteScroll(),this._attachListeners(),this._unsubscribe=m.subscribe(()=>this._refreshCardStates()),document.addEventListener("keydown",this._boundKeydown)}unmount(){this._fetchController?.abort(),this._unsubscribe?.(),this._observer?.disconnect(),document.removeEventListener("keydown",this._boundKeydown),this._closeModal(),clearTimeout(this._debounceTimer);const t=document.getElementById("router-outlet");t&&(t.style.overflow=""),document.body.style.overflow=""}_attachStyles(){if(document.getElementById("list-page-styles"))return;const t=document.createElement("style");t.id="list-page-styles",t.textContent=`
        ...
        <div id="lp-filters">
          <div class="lp-filter-row-wrap">
            <div class="lp-filter-row" id="lp-cat-row">
              ...
              ${G.map(t=>`<button class="lp-chip${t==="Todos"?" active":""}" data-cat="${t}">${t}</button>`).join("")}
            </div>
          </div>
          <div class="lp-filter-row-wrap">
            <div class="lp-filter-row" id="lp-obj-row">
              <span class="lp-filter-label">Objetivo</span>
              ${N.map(t=>`<button class="lp-chip" data-obj="${t}">${t}</button>`).join("")}
            </div>
          </div>
        </div>
    ...
    `}_renderStats(){const t=E.length,e=(m.stack||[]).length,o=_().size,l=E.filter(d=>d.evidenceLevel==="A").length,a=157.1,s=(d,f,x,y,k)=>{const g=this.container.querySelector(d),v=this.container.querySelector(f);if(!g||!v)return;v.textContent=x;const i=y>0?Math.min(1,x/y):0;g.style.stroke=k,g.style.strokeDashoffset=a*(1-i)};s("#lp-ring-total","#lp-stat-total",t,t,"var(--color-brand)"),s("#lp-ring-stack","#lp-stat-stack",e,t,"#8B5CF6"),s("#lp-ring-favs","#lp-stat-favs",o,t,"#EF4444"),s("#lp-ring-eva","#lp-stat-eva",l,t,"#22C55E"),this.container.querySelector("#lp-stat-stack")?.closest(".lp-stat-box")?.classList.toggle("stat--empty",e===0)}_applyFilters(){let t=this._allItems;this._query.trim()&&(t=this._fuse?this._fuse.search(this._query).map(o=>o.item):t.filter(o=>o.name.toLowerCase().includes(this._query.toLowerCase()))),t=t.filter(o=>U(o,this._category)),t=t.filter(o=>K(o,this._objective)),this._filtered=t;const e=this.container.querySelector("#lp-results-label");e&&(e.textContent=this._query||this._category!=="Todos"||this._objective?`${this._filtered.length} resultado(s)`:"")}_renderGrid(){if(this._modalOpen)return;const t=this.container.querySelector("#lp-grid");if(!t)return;if(this._page=0,t.innerHTML="",!this._filtered.length){t.innerHTML=`
        <div class="lp-empty">
